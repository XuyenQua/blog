            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row flex-between-center">
                        <div class="col-md">
                            <h5 class="mb-2 mb-md-0">Show post : {{ $post->title }}</h5>
                        </div>
                        <div class="col-auto">
                            <a class="btn btn-outline-secondary me-2" href="{{ route('admin.post.index') }}">List</a>
                            <a class="btn btn-outline-secondary me-2" href="{{ route('admin.post.edit', $post->id) }}">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="is_published" id="is_published" disabled class="form-control">
