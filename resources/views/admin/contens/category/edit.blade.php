            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row flex-between-center">
                        <div class="col-md">
                            <h5 class="mb-2 mb-md-0">Edit category</h5>
                        </div>
                        <div class="col-auto">
                            ...
                            <button class="btn btn-primary" role="button">Edit category</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="category_description" name="category_description" cols="100" rows="5">{{ $category->description }}</textarea>
