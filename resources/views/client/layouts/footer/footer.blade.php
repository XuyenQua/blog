            ...
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        ...
                        @foreach ($categories as $item)
                            <li><a href="{{ route('client.post', ['slug'=>$item->slug]) }}"><i class="bi bi-chevron-right"></i>{{$item->name}}</a></li>
                        @endforeach
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="footer-links footer-blog-entry list-unstyled">
                        @php
                            $posts = \App\Models\Post::orderBy('id', 'desc')->limit(4)->get();

                        @endphp
                        @foreach ($posts as $item)
                            <li>
                                <a href="{{ route('client.post', ['slug'=>$item->slug]) }}" class="d-flex align-items-center">
                        ...
                        {{-- <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="{{ asset('theme/client/assets/img/post-sq-1.jpg') }}" alt=""
                                    class="img-fluid me-3">
                                <div>
