                        ...
                        <div class="swiper-wrapper">
                            @foreach ($slider as $item)
                                <div class="swiper-slide">
                                    <a href="{{ route('client.post', ['slug' => $item->slug]) }}"
                ...
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        ...
                        <div class="post-meta">
                            ...
                            <span>{{ $postLast->created_at->format('d M Y') }}</span>
                        </div>
                        <h2><a href="{{ route('client.post', ['slug' => $postLast->slug]) }}">{{ $postLast->title }}</a></h2>
                        <p class="mb-4 d-block">{{$postLast->short_description}}</p>

                        <div class="d-flex align-items-center author">
                            {{-- <div class="photo"><img src="{{ asset('theme/client/assets/img/person-1.jpg') }}"
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                @foreach ($item as $post)
                                    ...
                                    <div class="post-entry-1">
                                        <a href="{{ route('client.post', ['slug' => $post['slug']]) }}"><img
                                                src="{{ asset('storage/' . $post['image']) }}"
                                                alt="" class="img-fluid"></a>
                                        <div class="post-meta">
                                            {{-- <span class="date">Sport</span> 
                                            <span class="mx-1">&bullet;</span>  --}}
                                            <span>{{ \Carbon\Carbon::parse($post['created_at'])->format('d M Y') }}</span></div>
                                        <h2>
                                            <a href="{{ route('client.post', ['slug' => $post['slug']]) }}">{{$post['title']}}</a></h2>
                                    </div>
                                @endforeach
                            </div>
                        @endforeach
                        ...
                        {{-- <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('theme/client/assets/img/post-landscape-3.jpg') }}" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('theme/client/assets/img/post-landscape-6.jpg') }}" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('theme/client/assets/img/post-landscape-8.jpg') }}" alt=""
                                        class="img-fluid"></a>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="trending">
                                ...
                                <ul class="trending-post">
                                    @foreach ($trendings as $index => $item)
                                        <li>
                                            <a href="{{ route('client.post', ['slug' => $item->slug]) }}">
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                            <img src="{{ asset('theme/client/assets/img/post-landscape-6.jpg') }}" alt=""
                                class="img-fluid">
                        </a>
                        <div>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('theme/client/assets/img/person-2.jpg') }}" alt="" class="img-fluid">
                                </div>
                                <div class="name">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="single-post.html"><img
                                        src="{{ asset('theme/client/assets/img/post-landscape-1.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('theme/client/assets/img/post-landscape-2.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                ...
                <div class="col-md-9 order-md-2">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                            <img src="{{ asset('theme/client/assets/img/post-landscape-3.jpg') }}" alt="" class="img-fluid">
                        </a>
                        <div>
                            <div class="post-meta"><span class="date">Business</span> <span
                                    class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('theme/client/assets/img/person-4.jpg') }}" alt="" class="img-fluid">
                                </div>
                                <div class="name">
                                    <h3 class="m-0 p-0">Wade Warren</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-5.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Business</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="single-post.html">11 Work From Home Part-Time Jobs You
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-7.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Business</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="single-post.html">How to Avoid Distraction and Stay
    ...
    {{-- <section class="category-section">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-8.jpg') }}" alt=""
                                class="img-fluid"></a>
                        ...
                        <div class="d-flex align-items-center author">
                            <div class="photo"><img src="{{ asset('theme/client/assets/img/person-7.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="name">
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-6.jpg') }}" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-4.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                        ...
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-3.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2><a href="single-post.html">6 Easy Steps To Create Your Own Cute Merch For
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-2.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ asset('theme/client/assets/img/post-landscape-1.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2><a href="single-post.html">5 Great Startup Tips for Female Founders</a></h2>
